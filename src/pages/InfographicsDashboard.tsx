  ...
  const initializeCharts = () => {
    ...
    */
    const dataConfig = {
      ...
      // Cost Structure (3.1) - Year 1 Breakdown
      costStructure: {
      ...
      // Revenue Categories (3.2.1/3.2.3) - Stacked Bar (₦ Billions)
      revenueCategories: {
        labels: ['Year 1', 'Year 2', 'Year 3'],
      ...
      // Competitive Landscape (2.2) - Agent Network Size (Units)
      agentNetwork: {
    ...
    */
    ...
    /*
    ====================================================================
    6. Cost Structure Breakdown (Doughnut Chart) (3.1)
    ====================================================================
    */
    createChart(
      'costStructureChart',
    ...
    */
    ...
    /*
    ====================================================================
    8. Competitive Landscape: Agent Network Size (Bar Chart) (2.2)
    ====================================================================
    */
    createChart(
      'agentNetworkChart',
    ...
    */
    ...
    /*
    ====================================================================
    12. Revenue Contribution by Service Category (Stacked Bar) (3.2.1/3.2.3)
    ====================================================================
    */
    createChart(
    ...
    console.log("Infographics Dashboard fully loaded with all charts.");
  };
  ...
  return (
    <>
      <style>{`
        ...
        .infographics-chart-container {
          position: relative;
          height: 350px;
        }
      `}</style>
      
      <div className="infographics-body p-4 sm:p-8">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <header className="text-center py-6 bg-white rounded-xl infographics-card mb-8 border-t-4 border-indigo-500">
          ...
          <main className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white p-6 rounded-xl infographics-card">
              <h2 className="text-xl font-bold mb-4 text-indigo-600 border-b pb-2">1. Projected Revenue Growth (₦ Billions) - Y1 to Y3</h2>
              <div className="infographics-chart-container">
                <canvas id="revenueChart"></canvas>
              </div>
            </div>

            {/* Card 2: Strategic Metrics (Text/Metrics) - 1 Span */}
            <div className="bg-white p-6 rounded-xl infographics-card flex flex-col justify-between">
              <div>
            ...
            <div className="lg:col-span-3 bg-white p-6 rounded-xl infographics-card">
            ...
            <div className="bg-white p-6 rounded-xl infographics-card">
            ...
            {/* Card 8: Competitive Landscape - 1 Span */}
            <div className="bg-white p-6 rounded-xl infographics-card">
            ...
            <div className="lg:col-span-2 bg-white p-6 rounded-xl infographics-card">
              ...
              <div className="infographics-chart-container max-w-xl mx-auto">
            ...
            {/* Card 12: Revenue Categories - 3 Span */}
            <div className="lg:col-span-3 bg-white p-6 rounded-xl infographics-card">
            ...
            {/* Card 13: Recommendations - 3 Span */}
            <div className="lg:col-span-3 bg-gradient-to-br from-indigo-50 via-white to-purple-50 p-8 rounded-xl infographics-card border-t-4 border-indigo-700 shadow-lg">
